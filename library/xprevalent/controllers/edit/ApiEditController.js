...
const BaseEditController_1 = __importDefault(require("./BaseEditController"));
class ApiEditController extends BaseEditController_1.default {
    handleRequest() {
...
module.exports = ApiEditController;
